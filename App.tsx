...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error) {
        ...
        alert(`Failed to submit property request: ${error.message}. Please check console for details.`);
      } else {
      ...
      console.error('An unexpected error occurred during property request submission:', unexpectedError);
  ...
  const handleContactSubmit = async (e) => {
    ...
    try {
      ...
      console.error('An unexpected error occurred during contact message submission:', unexpectedError);
      alert('An unexpected error occurred during message submission. Please try again.');
    }
  };
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    id="location"
                    name="location"
                    placeholder="e.g., suburb within NSW (Australia) only"
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div>
      ...
      <address className="not-italic text-teal-200 text-sm space-y-2">
        ...
        <p>ABN: 58465658836</p>
        <p className="text-teal-300 mt-2">Made in Sydney</p>
      </address>
    </div>
  </div>
